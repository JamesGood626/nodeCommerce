...
test("Successfully creates a user and hashes the password", async () => {
  ...
  const passwordMatches = await compareUserPassword(
    "richard@gmail.com",
    "password"
  );
  if (user) {
...
test(`Successfully updates the user's password`, async () => {
  ...
  const passwordShouldntMatch = await compareUserPassword(
    "richard@gmail.com",
    "password"
  );
  const passwordShouldMatch = await compareUserPassword(
    "richard@gmail.com",
    "hasNewPassword"
  );
